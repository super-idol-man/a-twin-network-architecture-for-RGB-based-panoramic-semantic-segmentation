...
from trainer64 import Trainer
parser = argparse.ArgumentParser(description="360 Degree Panorama semantic segmentationb Training")

# dataset
parser.add_argument("--root", default="G:\\stanford2d3d\\", type=str, help="path to the dataset.")

parser.add_argument("--dataset", default="stanford2d3d", choices=["stanford2d3d"],
...
parser.add_argument("--num_classes", type=int, default=13, help="semantic number")
...
parser.add_argument("--load_weights_dir",#default='G:\fuse\experiments\panodepth\models\weights_11\\',
